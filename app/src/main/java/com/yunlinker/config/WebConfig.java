...
public class WebConfig {
    ...
    //public static String AssestRoot = "http://192.168.0.119:8020/html_dlmNew/";



    public static final String WXID = "wx88ab611ecccf44fa";
    public static final String WXSECRET = "4ad3186b48e73a8aeb207d0bca363a79";

    public static final String QQID ="1108866959";
    public static final String QQSECRET ="yTlOfQjqLBuqF9da";

    public static final String QYSECRET = "e69e0593f2546c70496d67eddc041dd4";

    public static final String UMKEY = "5c91cf3b3fc195202b000f30";

    public static final String bucket = "gddoctor";
